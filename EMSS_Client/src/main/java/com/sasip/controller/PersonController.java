...
public class PersonController {
	...
	public String personList(Model model, HttpServletRequest request) {
		 ...
		 * }
		 */
		System.out.println("/personlist invoked");
	/*	if (feature_X) {
			LOG.info(" SASI-F1 ON");
		} else {
			LOG.info(" SASI-F1 OFF");
		}
	*/	System.out.println("/personlist invoked checking Service-Health-Check start");
		if(ff4j.check("Service-Health-Check")) {
			LOG.info(">>>>>>>      @@@@@@@       Service-Health-Check is enabled      @@@@@@@  <<<<<<<<<");
		}
		System.out.println("/personlist invoked checking Service-Health-Check end");
	...
	public String addNumbers(RedirectAttributes redirectModel, @RequestParam("numOne") int numOne,
	...
	public String modifyPerson(Model model, @PathVariable String firstName, @PathVariable String lastName,
			@PathVariable String whoIs) {
